	...
	<div class="container-fluid bg-light" style="min-height: 100vh">
		<div class="container">
			...
			<div align="center">
			    ...
			    <a href="confirmadd?question=<%= qstn.getQuestion() %>&keywords=<%= qstn.getKeywords() %>"><input type="submit" class="btn btn-primary" value="Yes"></a>
			    <a href="addquestion.jsp"><input type="submit" class="btn btn-secondary" value="No"></a>
