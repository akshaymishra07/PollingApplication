		...
		<div class="container">
			<div align="center">
				<table class="table-borderless">
					...
					<tr>
						<td align="center"><a
							href="increment?questionId=${question.questionId }&option=yes"><button
									type="button" class="btn btn-success"
									style="margin-top: 50px; width: 50%;">Yes</button></a></td>
					</tr>
					<tr>
						<td align="center"><a
							href="increment?questionId=${question.questionId }&option=no"><button
									type="button" class="btn btn-danger"
									style="margin-top: 15px; width: 50%;">No</button></a></td>
					</tr>
					<tr>
						<td align="center"><a
							href="increment?questionId=${question.questionId }&option=notSure"><button
									type="button" class="btn btn-warning"
									style="margin-top: 15px; width: 50%;">Not Sure</button></a></td>
					</tr>
				</table>
			</div>
